const uint8_t FreeMonoBitmaps[] PROGMEM = {
...
const GFXglyph FreeMonoGlyphs[] PROGMEM = {
    {0, 0, 0, 14, 0, 1},        // 0x20 ' '
    {0, 3, 15, 14, 6, -14},     // 0x21 '!'
    {6, 8, 7, 14, 3, -14},      // 0x22 '"'
...
const GFXfont FreeMono PROGMEM = {(uint8_t *)FreeMonoBitmaps,
                                        (GFXglyph *)FreeMonoGlyphs, 0x20,
                                        0x7E, 24};
