const uint8_t FreeSansBoldBitmaps[] PROGMEM = {
    ...
    0x01, 0xE0, 0x30, 0x78, 0x78, 0x30, 0x00, 0x30, 0x30,
    0x38, 0x6C, 0xC6, 0xC6, 0x6C, 0x38, 0x00 };
	

const GFXglyph FreeSansBoldGlyphs[] PROGMEM = {
    {0, 0, 0, 7, 0, 1},         // 0x20 ' '
    {0, 4, 17, 8, 3, -16},      // 0x21 '!'
    {9, 10, 6, 11, 1, -17},     // 0x22 '"'
	...
	{2185, 7, 7, 8, 0, -12}}; // 0xB0 '°'

const GFXfont FreeSansBold PROGMEM = {
    (uint8_t *)FreeSansBoldBitmaps, (GFXglyph *)FreeSansBoldGlyphs,
    0x20, 0xB0, 29};
